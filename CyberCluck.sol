...
contract CyberCluck is Ownable, ERC721URIStorage {
    ...
    function buyBlindBox() public {
        ...
        require(
            tokenEgg.balanceOf(msg.sender) >= price * 10**18,
            "Balance of Egg token is not enought to buy BlindBox"
        );

        tokenEgg.transferFrom(msg.sender, ownerAddr, price * 10**18);
